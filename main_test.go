...
func TestCmd(t *testing.T) {
	...
	assert.Match(`panic\(errors\.New`, get("http://127.0.0.1:8000/panic")) // should show code snippet
	assert.Match("index out of range", get("http://127.0.0.1:8000/error")) // should be able to detect runtime error
	assert.Match(`paths\[0\] = `, get("http://127.0.0.1:8000/error"))      // should show code snippet
